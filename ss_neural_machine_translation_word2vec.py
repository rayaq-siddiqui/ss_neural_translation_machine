# python ss_neural_machine_translation_word2vec.py --path 'fra-eng/fra.txt' --epochs 20 --batch_size 32 --latent_dim 128 --num_samples 40000 --outdir 'trained_model/' --verbose 1 --mode train --embedding_dim 128
...
class MachineTranslation:
    ...
    # constructors remain basically the same
    # gets the user defined inputs to run the function
    def __init__(self):
        ...
        self.embedding_dim = args.embedding_dim   # new variable
    ...
    # read the input file and produces input_texts,target_texts,input_words,target_words
    # out : list, list, set, set
    ...
    # identifies which sentences to use and which words are inside the vocabulary
    ...
    # this is changed with the word to vector embeddings
    # Embedding is the new key term
    def process_input(self,input_texts,target_texts=None,verbose=True):
        ...
        if self.mode == 'train':
            ...
            # additional embedded vectors are created
    ...
    # the only difference is that the embedding is added to the encoder and decoder model
    ...
    # this is altered with the new embedding
    # the reverse of a word is used with a possibility of errors
